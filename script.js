        ...
        class SolarSystem {
            constructor() {
                ...
                this.planetData = [
                    { name: 'Mercury', radius: 0.8, distance: 8, speed: 4.74, color: 0x8c7853 },
                    { name: 'Venus', radius: 1.2, distance: 11, speed: 3.50, color: 0xffc649 },
                    { name: 'Earth', radius: 1.3, distance: 15, speed: 2.98, color: 0x6b93d6 },
                    { name: 'Mars', radius: 1.0, distance: 20, speed: 2.41, color: 0xc1440e },
                    { name: 'Jupiter', radius: 3.5, distance: 28, speed: 1.31, color: 0xd8ca9d },
                    { name: 'Saturn', radius: 3.0, distance: 38, speed: 0.97, color: 0xfad5a5 },
                    { name: 'Uranus', radius: 2.0, distance: 48, speed: 0.68, color: 0x4fd0e7 },
                    { name: 'Neptune', radius: 1.9, distance: 58, speed: 0.54, color: 0x4b70dd }
                ];
            ...
            createControlPanel() {
                ...
                this.planetData.forEach((planetInfo, index) => {
                    ...
                    label.innerHTML = `
                        <span class="planet-color" style="background-color: #${planetInfo.color.toString(16).padStart(6, '0')}"></span>
                        ${planetInfo.name}
                    `;
                ...
                if (intersects.length > 0) {
                    ...
                    if (planet !== this.hoveredPlanet) {
                        ...
                        tooltip.innerHTML = `
                            ...
                            Speed: ${planet.userData.currentSpeed.toFixed(1)}x<br>
            ...
            resetPlanets() {
                this.planets.forEach((planet, index) => {
                    planet.rotation.y = 0;
                    this.planetMeshes[index].userData.currentSpeed = this.planetData[index].speed;
                    ...
                    valueDisplays[index].textContent = this.planetData[index].speed.toFixed(1);
                });
            }
            ...
            toggleTheme() {
                ...
                document.getElementById('theme-btn').textContent = this.isDarkTheme ? 'Light Mode' : 'Dark Mode';
